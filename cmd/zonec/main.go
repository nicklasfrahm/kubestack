...
import (
	...
	"github.com/nicklasfrahm/kubestack/controllers"
...
func init() {
	...
	utilruntime.Must(kubestackv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "zonec.kubestack.nicklasfrahm.dev",
	...
	if err = (&controllers.InterfaceReconciler{
		...
		setupLog.Error(err, "failed to create controller", "controller", "Interface")
		os.Exit(1)
	}
